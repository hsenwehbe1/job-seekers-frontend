...
class Type1 extends Component{
    ...
    render() {
        ...
        return (
            <div className='mb-3'>
                <textarea onClick={this.clickHandler} type="text" className={`px-3 py-2 ${classes.input} ${this.state.selected[0]}`} readOnly value={option1} id='0q2'/><br></br>
                <textarea onClick={this.clickHandler} type="text" className={`px-3 py-2 mt-3 ${classes.input} ${this.state.selected[1]}`} readOnly value={option2} id='1q2'/><br></br>
                <textarea onClick={this.clickHandler} type="text" className={`px-3 py-2 mt-3 ${classes.input} ${this.state.selected[2]}`} readOnly value={option3} id='2q2'/><br></br>
                <textarea onClick={this.clickHandler} type="text" className={`px-3 py-2 mt-3 ${classes.input} ${this.state.selected[3]}`} readOnly value={option4} id='3q2'/><br></br>
                <textarea onClick={this.clickHandler} type="text" className={`px-3 py-2 mt-3 ${classes.input} ${this.state.selected[4]}`} readOnly value={option5} id='4q2'/>
            </div>
        )
    }
}
